...
jest.mock('fluent-ffmpeg', () => {
    ...
    // ⚠️ ffprobe é um método estático na lib original, então precisa ser adicionado assim:
    Object.assign(ffmpegFn, {
      ffprobe: jest.fn((filePath: string, cb: (err: any, metadata: any) => void) => {
...
describe('FrameExtractorHandler', () => {
    ...
    it('should throw an error if ffprobe fails', async () => {
        ...
        (Ffmpeg as unknown as jest.Mock & { ffprobe: jest.Mock }).ffprobe.mockImplementationOnce(
